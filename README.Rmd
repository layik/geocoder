...
# development
To run all the tests, you will require mongo to run. Once you are sure that you have a container running as outliend above, you will need a flag in your R environment `GEOCODER_MONGODB_AVAILABLE=true`. You can use R package `usethis::edit_r_environ()`. 
